...
function ProductList({ onHomeClick }) {
    ...
    const [addedToCart, setAddedToCart] = useState({});  //cart is empty by default
    ...
    //this is janky but the instructions told me to use component state (useState()) for addedToCart, not a redux state so....
    useEffect(() => {
        const next = {};
